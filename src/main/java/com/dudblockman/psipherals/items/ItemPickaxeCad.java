...
import com.teamwizardry.librarianlib.features.base.item.ItemModPickaxe;
...
public class ItemPickaxeCad extends ItemModPickaxe implements ICAD, ISpellSettable, IItemColorProvider {
    ...
    public void castOnBlockBreak(ItemStack itemstack, PlayerEntity player) {
        ...
        if (!playerCad.isEmpty()) {
            ...
            ItemCAD.cast(player.getEntityWorld(), player, data, bullet, playerCad, 5, 10, 0.05F, (SpellContext context) -> {
                ...
                context.positionBroken = IPsimetalTool.raytraceFromEntity(player.getEntityWorld(), player, false, player.getAttributeMap().getAttributeInstance(PlayerEntity.REACH_DISTANCE).getAttributeValue());
            });
        }
    }
    @Override
    ...
    public static ItemStack makeCADWithAssembly(ItemStack assembly, List<ItemStack> components) {
        ItemStack cad = assembly.getItem() instanceof ICADAssembly ?
                ...
                new ItemStack(Items.pickaxeCAD);
    ...
    public void getSubItems(@Nonnull ItemGroup tab, @Nonnull NonNullList<ItemStack> subItems) {
        ...
        // Iron Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssembly, 1, 0),
                new ItemStack(ModItems.cadCore, 1, 0),
                new ItemStack(ModItems.cadSocket, 1, 0),
                new ItemStack(ModItems.cadBattery, 1, 0)));
        // Gold Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssembly, 1, 1),
                new ItemStack(ModItems.cadCore, 1, 0),
                new ItemStack(ModItems.cadSocket, 1, 0),
                new ItemStack(ModItems.cadBattery, 1, 0)));
        // Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssembly, 1, 2),
                new ItemStack(ModItems.cadCore, 1, 1),
                new ItemStack(ModItems.cadSocket, 1, 1),
                new ItemStack(ModItems.cadBattery, 1, 1)));
        // Ebony Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssembly, 1, 3),
                new ItemStack(ModItems.cadCore, 1, 3),
                new ItemStack(ModItems.cadSocket, 1, 3),
                new ItemStack(ModItems.cadBattery, 1, 2)));
        // Ivory Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssembly, 1, 4),
                new ItemStack(ModItems.cadCore, 1, 3),
                new ItemStack(ModItems.cadSocket, 1, 3),
                new ItemStack(ModItems.cadBattery, 1, 2)));
        // Creative CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssembly, 1, 5),
                new ItemStack(ModItems.cadCore, 1, 3),
                new ItemStack(ModItems.cadSocket, 1, 3),
                new ItemStack(ModItems.cadBattery, 1, 2)));
    }
