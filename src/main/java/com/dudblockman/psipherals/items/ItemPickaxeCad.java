...
public class ItemPickaxeCad extends PickaxeItem implements ICAD {
    ...
    public void fillItemGroup(@Nonnull ItemGroup tab, @Nonnull NonNullList<ItemStack> subItems) {
        ...
        // Iron Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssemblyIron),
                new ItemStack(ModItems.cadCoreBasic),
                new ItemStack(ModItems.cadSocketBasic),
                new ItemStack(ModItems.cadBatteryBasic)));
        // Gold Psimetal CAD
        subItems.add(makeCAD(new ItemStack(Items.pickaxeAssemblyGold),
                new ItemStack(ModItems.cadCoreBasic),
                new ItemStack(ModItems.cadSocketBasic),
                new ItemStack(ModItems.cadBatteryBasic)));
        // Psimetal CAD
