...
@Mod(Psipherals.MODID, name = Psipherals.NAME, version = Psipherals.VERSION, dependencies = "required-after:psi@[r1.1-75,);required-after:librarianlib;required-after:forge@[14.23.5.2768,);", useMetadata = true)
